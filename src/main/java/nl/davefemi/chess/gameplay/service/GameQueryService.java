package nl.davefemi.chess.gameplay.service;
...
public class GameQueryService {
    ...
    public GameStatus getCurrentGameStatus(UUID sessionId) throws SessionException, BoardException, SessionNotFoundException {
