...
public class Game {
    ...
    public Game(String id, int currentRound, GameBoardContext boardContext, GameStatus status, Color sideToMove, boolean inCheck,
    ...
    public synchronized boolean executeMove(Color color, Move move) throws GameException, MoveException, BoardException {
        ...
        if (status.isActive() && turnGenerator.peek() == Color.WHITE) {
            currentRound++;
        }
        return true;
    }
